...
- 개발언어: Kotlin  
- 라이브러리: Spring Boot, Spring Cloud, H2  
...
> Eureka 설계 특성상 서비스의 UP/DOWN 감지에 약간의 시간이 소요될 수 있습니다.  
> 이로 인해 일시적으로 통신이 원활하지 않는 현상이 발생할 수도 있습니다.
...
검색 결과가 없거나 검색 결과를 제대로 가져오지 못하더라도 누적됩니다.  
